...
app.get('/', (req, res) => {
    res.send(`
            <body>
                ...
                <p>Endpoint que leva aos incidentes cadastrados: <a href="https://zelacidade-cdb0.onrender.com/incidentes">/incidentes</a></p>
                <p>Endpoint que leva aos incidentes cadastrados: <a href="https://zelacidade-cdb0.onrender.com/incidentes/4">/incidentes especificos</a></p>
